...
<div id="checkoutModal">
    ...
    <@sf.form action="/admin/car_registration" method="post" id="checkout-form" name="checkout-form" modelAttribute="regform">
        <!-- Modal body start -->
        <div class="modal-body">
            ...
            <div class="checkout-personal-info">
                ...
                <div class="form-group left">
                    ...
                    <@sf.input path="model" type="text" class="form-control" name="model" id="model" placeholder="Enter car's model"/>
                    <@sf.errors path="model" class = "form-control alert alert-warning text-center"/>
                </div>
                <div class="form-group right">
                    <label for="luggage">Luggage :</label>
                    <@sf.input path="luggage" type="text" class="form-control" name="luggage" id="luggage" placeholder="Enter car's luggage"/>
                    <@sf.errors path="luggage" class = "form-control alert alert-warning text-center"/>
                </div>
                <div class="form-group left">
                    <label for="doors">Doors:</label>
                    <@sf.input path="doors" type="text" class="form-control" name="doors" id="doors" placeholder="Enter car's doors"/>
                    <@sf.errors path="doors" class = "form-control alert alert-warning text-center"/>
                </div>
                <div class="form-group right">
                    <label for="seats">Seats:</label>
                    <@sf.input path="seats" type="text" class="form-control" name="seats" id="seats" placeholder="Enter car's seats"/>
                ...
                <div class="form-group left">
                    ...
                    <div class="styled-select-age">
                        <@sf.select path="air_cond" name="air_cond" id="air_cond">
                ...
                <div class="form-group right age">
                    ...
                    <div class="styled-select-age">
                        <@sf.select path="transmission" name="transmission" id="transmission">
