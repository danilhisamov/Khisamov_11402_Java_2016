...
<section id="vehicles" class="container" style="margin-left: 100px;margin-top: 120px">
    <div class="row">
        <!-- Vehicle nav start -->
        <div class="col-md-3 wow fadeInUp" data-wow-offset="100">
            <div id="vehicle-nav-container">
                <ul class="vehicle-nav">
                    <#if cars?? && cars?has_content>
                    <#assign k=1>
                        <#list cars as car>
                            <#if k < 2>
                                <li class="active" onclick="getCar(${car.id})"><a>${car.model}</a><span class="active">&nbsp;</span></li>
                            <#else>
                                <li onclick="getCar(${car.id})"><a>${car.model}</a><span class="active">&nbsp;</span></li>
                            </#if>
                        <#assign k=k+1>
                        </#list>
                    </#if>
        ...
        <div class="vehicle-data" id="vehicle" style="display: ">
            ...
            <div class="col-md-3 wow fadeInUp" data-wow-offset="200">
                <div class="vehicle-price" id="car-price"><div id="price" style="float: left">${car.price}</div><span class="info">&nbsp;rent per day</span></div>
